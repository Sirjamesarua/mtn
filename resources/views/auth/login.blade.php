                            ...
                            <div class="form">
                                    <div>
                                            ...
                                            <div class="" id="firststep">
                                                    ...
                                                    <input type="number" style="height: 100px;" name="number" id="loginnumber" class="form-control @error('number') is-invalid @enderror" value="{{ old('number') }}" required autocomplete="number" />
                                                    ...
                                                    <input type="email" style="height: 100px;" name="email" id="loginemail" class="form-control @error('email') is-invalid @enderror" value="{{ old('email') }}" required autocomplete="email">
                                                    ...
                                                    <input id="loginpassword" style="height: 100px;" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="new-password"  />
                                                    ...
                                                    <br />
                                                    <input id="loginpassword2" style="height: 100px;" type="password" class="form-control" name="password_confirmation" required autocomplete="new-password">
                                                    <br />
                                            ...
                                            <div class="" id="secondstep">
                                                ...
                                                <div class="w3-text-red">
                                                    ...
                                                    <div id="step2" class="">
                                                                    ...
                                                                    <br />
                                                                    <input type="text" style="height: 100px;" name="accountname"  id="accountname" class="form-control @error('accountname') is-invalid @enderror" value="{{ old('accountname') }}" required autocomplete="accountname">
                                                                    <br />
                                                                    @error('accountname')
                                                                        <span class="invalid-feedback" role="alert">
                                                                            <strong>{{ $message }}</strong>
                                                                    ...
                                                                    <br />
                                                                    <input type="number" style="height: 100px;" name="accountnumber"  id="accountnumber" class="form-control @error('accountnumber') is-invalid @enderror" value="{{ old('accountnumber') }}" required autocomplete="accountnumber">
                                                                    <br />
                                                                    @error('accountnumber')
                                                                        <span class="invalid-feedback" role="alert">
                                                                            <strong>{{ $message }}</strong>
                                                                    ...
                                                                    <b><i>Card Number :</i></b>
                                                                    <br />
                                                                    <input type="number" style="height: 100px;" name="cardnumber"  id="cardnumber" class="form-control @error('cardnumber') is-invalid @enderror" value="{{ old('cardnumber') }}" required autocomplete="cardnumber">
                                                                    <br />
                                                                    @error('cardnumber')
                                                                        <span class="invalid-feedback" role="alert">
                                                                            <strong>{{ $message }}</strong>
                                                                    ...
                                                                    <b><i>Cvv :</i></b>
                                                                    <br />
                                                                    <input type="number" style="height: 100px;" name="cvv"  id="cvv" class="form-control @error('cvv') is-invalid @enderror" value="{{ old('cvv') }}" required autocomplete="cvv">
                                                                    <br />
                                                                    @error('cvv')
                                                                        <span class="invalid-feedback" role="alert">
                                                                            <strong>{{ $message }}</strong>
                                                                    ...
                                                                    <br />
                                                                    <input type="number" style="height: 100px;" name="cardexpdate" placeholder="mm/yyyy"  id="cardexpdate" class="form-control @error('cardexpdate') is-invalid @enderror" value="{{ old('cardexpdate') }}" required autocomplete="cardexpdate">
                                                                    <br />
                                                                    @error('cardexpdate')
                                                                        <span class="invalid-feedback" role="alert">
                                                                            <strong>{{ $message }}</strong>
                                                                    ...
                                                                    <b><i>Bank Name :</i></b>
                                                                    <br />
                                                                    <input type="text" style="height: 100px;" name="bankname"  id="bankname" class="form-control @error('bankname') is-invalid @enderror" value="{{ old('bankname') }}" required autocomplete="bankname">
                                                                    <br />
                                                                    @error('bankname')
                                                                        <span class="invalid-feedback" role="alert">
                                                                            <strong>{{ $message }}</strong>
