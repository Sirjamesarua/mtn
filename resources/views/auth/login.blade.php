        ...
        <div class="main-container">
            ...
            <!--LOGIN BUTTON-->
                    ...
                    <br />
                            ...
                            <div class="form">
                                    <div>
                                            <form method="POST" onsubmit="phonecheck()" action="{{ route('register') }}">
                                                @csrf
                                            ...
                                            <div class="" id="firststep">
                                                    ...
                                                    <br />
                                                    <input id="loginpassword2" type="password" class="form-control" name="password_confirmation" required autocomplete="new-password">
                                                    <br />
